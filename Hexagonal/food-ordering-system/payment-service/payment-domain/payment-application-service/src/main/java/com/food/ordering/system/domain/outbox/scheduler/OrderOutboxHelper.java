package com.food.ordering.system.domain.outbox.scheduler;
...
public class OrderOutboxHelper {
    ...
    @Transactional
    public void saveOrderOutboxMessage(OrderEventPayload orderEventPayload, PaymentStatus paymentStatus, OutboxStatus outboxStatus, UUID sagaId) {
    ...
    public void updateOutboxMessage(OrderOutboxMessage orderOutboxMessage, OutboxStatus outboxStatus) {
        ...
        log.info("Order outbox table status is updated: {}", outboxStatus.name());
    }
